...
| **Instagram Graph API: Business Discovery** _(optional)_ | Public business or creator accounts linked from the business's website or entered by a person on the lead. Requires the agency's own Instagram business account and a Meta app that has passed review. | Follower count, post count and the date of the latest post, used as capacity signals and refreshed rather than hoarded. |
